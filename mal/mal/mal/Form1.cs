...
namespace mal
{
    public partial class Form1 : Form
    {
        ...
        void FillRgbPixel(int x, int y, int n, byte[]rgb)
        {
...
*/
            ...
            //передаем список, пройтись по нему ятобы он для каждого элемента в списке выполнил функцию
            Parallel.ForEach(points, p =>
            {
                FillRgbPixel(p.X, p.Y, n, rgb);
            });
